...
אין בריפו צינור מצלמה חי. מה שיש היום לפיילוט: [תקציר לעירייה](./pilot-brief.html) (עמוד אחד להדפסה), [ערכת פיילוט](./pilot-kit.html) (היוריסטיקת בהירות על תמונה סטטית — המודול ב-[`src/lib/heuristic.js`](./src/lib/heuristic.js)), [השוואת דיוק](./pilot-compare.html) (זיווג מול פקח + רווח סמך Wilson), [יומן 30 יום](./pilot-log.html) (פרוטוקול שדה + כלל העצירה מ־RESEARCH.md), [דוח פיילוט](./pilot-report.html) (כולל מפת חום שעתית לתכנון), [סיכום לקריאה בלבד](./pilot-summary.html) (קישור עם hash, בלי שרת), ו[בקשת גישה / פרטיות](./pilot-privacy.html). דפי הפיילוט נשמרים במטמון כ־PWA שדה. דיוק מול ספירת פקח עדיין לא נמדד בשטח — סדרת הדוגמה מסומנת `sample`.
